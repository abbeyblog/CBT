...
var questions = [
 ...
 ["Who was the first student to scam his/her parents?",
  "Yakubu Atore", "Ololade Bimpe", "Christiana Aina",
  "C"
 ],

 ["How much was the first handout sold?",
  "N50",
  "N20", "N90", "B"
 ],
...
function renderQuestion() {
 ...
 if (pos >= questions.length) {
  ...
  test.innerHTML = "<h3>You got " +
   ...
   .length +
   " questions correct. <br>SEE YOUR LIFE, OLODO BURUKU AFI OUNJE </h3>";
